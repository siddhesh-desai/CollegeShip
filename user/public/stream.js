...
function applyDropDown(){
    const selectLevel1Value = document.getElementById("is").value;
...
function applyDropDown2(){
    const selectLevel1Value = document.getElementById("is").value;
    const selectLevel2Value = document.getElementById("id").value;
    const selectLevel3 = document.getElementById("it");
...
function populateFirstLevelDropDown(){
    ...
    const el = document.getElementById("is")
...
document.getElementById("is").addEventListener("change",applyDropDown);
document.getElementById("id").addEventListener("change",applyDropDown2);
